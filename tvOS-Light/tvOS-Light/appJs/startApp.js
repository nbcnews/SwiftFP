...
console.log('3')
    ...
    _newArrowCheck(this, _this2);
      console.log('8', appMetadata.id, window[appMetadata.id])

    var bundle = APP_com_nbcnews_tvx//window[appMetadata.id]; // support rollup and esbuild
...
var hasTextureMode = function hasTextureMode(platformSettings) {
  ...
  _newArrowCheck(this, _this);
console.log('hasTextureMode', platformSettings)
  return new Promise(function (resolve) {
